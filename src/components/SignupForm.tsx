              ...
              <div className="relative">
                ...
                <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
                  <button
                    ...
                    className="text-gray-400 hover:text-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded transition-colors p-1"
                  >
