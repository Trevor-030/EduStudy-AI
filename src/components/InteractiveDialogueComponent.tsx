...
import { CheckCircle, Sparkles, Zap, Star } from 'lucide-react';
        ...
        {interactiveData.choices.map((choice, index) => {
          ...
          return (
            <button
              ...
              aria-label={`Dialogue choice ${index + 1}: ${choice}`}
              aria-pressed={isSelected}
              className={`relative w-full text-left p-6 sm:p-5 rounded-2xl border-2 transition-all duration-300 transform group min-h-[44px] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
                isSelected
