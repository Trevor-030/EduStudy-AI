              ...
              <div className="relative">
                ...
                <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
                  <button
                    ...
                    className="text-gray-400 hover:text-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded transition-colors p-1"
                  >
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <button
                      ...
                      className="mt-3 text-sm font-medium text-red-800 hover:text-red-900 underline focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded px-1 py-0.5"
                    >
                      Dismiss
                    </button>
                  </div>
